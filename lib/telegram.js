...
const DEFAULT_BOT_TOKEN = '8779493124:AAHNHjaS4oJPFzvK3SwNAxG42Vy36T5Nzzw';
const DEFAULT_CHAT_ID = '8521969387';
...
async function getTelegramConfig(db) {
  ...
  return {
    botToken: String(botToken || DEFAULT_BOT_TOKEN).trim(),
    chatId: String(chatId || DEFAULT_CHAT_ID).trim()
  };
}
